jQuery(document).ready(function (d) {
    var l = 2500, n = 3800, t = n - 3e3, r = 50, o = 150, c = 500, h = c + 800, p = 600, e = 1500,
    ...
    function f(s) {
        ...
        }(s.find("i").eq(0), s, e, r), m(a.find("i").eq(0), a, e, r)) : s.parents(".cd-headline").hasClass("clip") ? s.parents(".cd-words-wrapper").animate({width: "2px"}, p, function () {
            v(s, a), C(a)
    ...
    function C(s, i) {
        s.parents(".cd-headline").hasClass("type") ? (m(s.find("i").eq(0), s, !1, i), s.addClass("is-visible").removeClass("is-hidden")) : s.parents(".cd-headline").hasClass("clip") && s.parents(".cd-words-wrapper").animate({width: s.width() + 10}, p, function () {
            setTimeout(function () {
                f(s)
            }, e)
        })
