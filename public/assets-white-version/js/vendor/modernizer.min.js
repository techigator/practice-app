!function (s, f, c) {
    ...
    function a(e, t) {
        if ("object" == typeof e) for (var n in e) u(e, n) && a(n, e[n]); else {
    ...
    function r(e, t, n, o) {
        ...
        if (parseInt(n, 10)) for (; n--;) (s = p("div")).id = o ? o[n] : l + (n + 1), u.appendChild(s);
    ...
    function R(e, t) {
        ...
        if ("CSS" in s && "supports" in s.CSS) {
            for (; n--;) if (s.CSS.supports(l(e[n]), t)) return !0;
            return !1
        }
    ...
    function h(e, t, n, o) {
        ...
        for (l = e.length, a = 0; a < l; a++) if (u = e[a], f = B.style[u], ~("" + u).indexOf("-") && (u = u.replace(/([a-z])-([a-z])/g, function (e, t, n) {
    ...
    function o(e, t, n, o, r) {
        ...
        var u = l = (e + " " + P.join(a + " ") + a).split(" "), f = t, d = n;
        for (i in u) if (u[i] in f) if (!1 === d) return u[i]; else {
            s = f[u[i]];
            if (m(s, "function")) {
                var c = s;
                var p = d || f;
    ...
    var u, d, A, t, e, g, v, y, C, b, w, S = [], x = {
        ...
        }, M = (_.prototype = x, _ = new _, []), T = f.documentElement, E = "svg" === T.nodeName.toLowerCase(),
        W = "Moz O ms Webkit", P = x._config.usePrefixes ? W.toLowerCase().split(" ") : [],
        ...
        B = (_._q.push(function () {
            delete I.elem
        }), {style: I.elem.style}), k = (_._q.unshift(function () {
            delete B.style
            ...
            var e = p("canvas"), t = "probablySupportsContext" in e ? "probablySupportsContext" : "supportsContext";
    ...
    }), _.addTest("srcset", "srcset" in p("img")), _.addTest("webworkers", "Worker" in s), S) if (S.hasOwnProperty(w)) {
        if (e = [], (g = S[w]).name && (e.push(g.name.toLowerCase()), g.options && g.options.aliases && g.options.aliases.length)) for (v = 0; v < g.options.aliases.length; v++) e.push(g.options.aliases[v].toLowerCase());
